  ...
  return (
    <div>
      <div className="bg-[url('/homeAstro.png')] h-screen bg-cover flex flex-col">
        ...
        <hgroup className="flex flex-1 items-center justify-center ml-14 mr-14 gap-12">
          <div className="flex flex-col gap-4 basis-0 flex-1 center">
            <h3 className="font-bold text-2xl">满足用户使用AI多元化，差异化</h3>
            <h2 className="font-bold text-4xl">
              让每一个使用AI的人事半功倍探索无限可能。
            </h2>
            <p className="text-lg">
              Satisfy users' diverse and differentiated AI needs, Enable every
              AI user to achieve twice the results with half the effort, Explore
              endless possibilities.
            </p>
          </div>

          <div className="basis-0 flex-1 flex items-center justify-center flex-col gap-4">
            <h1 className="font-bold text-6xl">Prompt Flow</h1>
            <h3 className="font-bold text-2xl">AI users</h3>
            <Arc className="absolute"></Arc>
          </div>
        </hgroup>
